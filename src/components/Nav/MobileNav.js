...
const MobileNav = ({ active, setActive }) => (
  <div className="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden mobile-nav">
    <div className="rounded-lg bg-white overflow-hidden shadow-lg">
      ...
      <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
        ...
        <div role="none" className="mt-6 px-5 py-4 text-center border-t border-gray-200">
          <a href="/" className="text-base font-medium text-gray-900 hover:text-gray-700">
            Log in
          </a>
          <a href="/" className="ml-4 text-base font-medium text-gray-900 hover:text-gray-700">
            Sign up
          </a>
        </div>
      </div>
